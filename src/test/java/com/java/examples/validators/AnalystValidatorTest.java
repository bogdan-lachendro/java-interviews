...
public class AnalystValidatorTest {
    public static final Role ROLE = Role.Analyst;
    public static final String INVALID_ID = "1";
    public static final String VALID_ID = "a1";
    @InjectMocks private AnalystValidator validator;
